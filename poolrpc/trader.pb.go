...
type DepositAccountRequest struct {
	...
	LndUtxoAddress string `protobuf:"bytes,4,opt,name=lnd_utxo_address,json=lndUtxoAddress,proto3" json:"lnd_utxo_address,omitempty"`
	//
...
func (x *DepositAccountRequest) GetLndUtxoAddress() string {
	if x != nil {
...
var file_trader_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0e, 0x6c, 0x6e, 0x64, 0x55, 0x74, 0x78, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65,
